...
<body>
    <div class="container">
        ...
        <form action="treatmentUpdateWorks.php?id=<?= $id ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group-my-3">
                <div class="row">
                    <div class="col-4">
                        <img src="../images/<?= $don['image'] ?>" alt="image du produit <?= $don['title'] ?>" class="img-fluid">
                    </div>
                </div>
